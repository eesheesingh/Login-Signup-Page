...
if(isset($_POST['subforget']))
{
    ...
    if($result)
    {
        ...
        {
             $FromName="Login Page";
             $FromEmail="no_reply@gmail.com";
             $ReplyTo="chiro.singh9769@gmail.com";
             $credits="All Rights are reserved | Login Page";
             ...
             $subject="You have recieved an email for password reset";
             $msg="Your password reset link <br> http://localhost/logSignpagewithphp/password-reset.php?token=".$token."<br> Reset your password
             with this link. CLick or open in new tab <br><br> <br> <br> <center>".$credits."</center>";
